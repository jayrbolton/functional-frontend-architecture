...
var increment$ = _flyd2['default'].stream();
var reset$ = _flyd2['default'].stream();

// Our counter view (all the markup with event handler streams)
var view = function view(state) {
  return (0, _snabbdomH2['default'])('div', [(0, _snabbdomH2['default'])('p', 'Total count: ' + state), (0, _snabbdomH2['default'])('button', { on: { click: [increment$, 1] } }, 'Increment!'), (0, _snabbdomH2['default'])('button', { on: { click: [increment$, -1] } }, 'Decrement!'), (0, _snabbdomH2['default'])('button', { on: { click: reset$ } }, 'Reset!')]);
};

// Now we can use scanMerge to combine all our streams into a single state stream
var state$ = (0, _flydModuleScanmerge2['default'])([[increment$, function (count, n) {
  return count + n;
...
var patch = require('snabbdom').init([require('snabbdom/modules/eventlisteners')]);

// Plain HTML container node
var container = document.querySelector('#container');

// Generate a stream of new VTrees for every new value on the state stream
var vnode$ = _flyd2['default'].map(view, state$);

// scan over the updated vtree with the HTML container as the starting accumulator
var dom$ = _flyd2['default'].scan(patch, container, vnode$);

// Export the DOM stream so you can use it in tests
module.exports = dom$;

},{"flyd":2,"flyd/module/scanmerge":3,"snabbdom":12,"snabbdom/h":9,"snabbdom/modules/eventlisteners":11}],2:[function(require,module,exports){
...
},{"ramda/src/curryN":4}],3:[function(require,module,exports){
...
},{"./is":10,"./vnode":13}],10:[function(require,module,exports){
module.exports = {
  array: Array.isArray,
...
},{"./is":10,"./vnode":13}],13:[function(require,module,exports){
